...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO sickNote (Name, Gender, Email,Age, Phone,StartDate,EndDate,Diagnosis,MedicalAdvice) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"; // SQL with parameters
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssiissss", $Name, $Gender, $Email, $Age, $Phone, $stDate, $enDate, $Diagnosis, $MedicalAdvice);
    $stmt->execute();
}
