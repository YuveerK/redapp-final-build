...
<head>
    <meta charset="utf-8">
       <title> Profile Page - Red App</title>
...
.card {
    ...
    box-shadow: 0 1px 15px 1px rgba(255,0,0,0.3);
}
.card {
    position: relative;
    display: -ms-flexbox;
...
.card-header {
    ...
    color: inherit;
    background-color: #fff;
    border-bottom: 1px solid #f2e5e7;
}
...
<body>
<center><img src="C:\profile settings page\RedApp.jpeg"></center>
