...
<div class="img bg-wrap text-center py-4">
	  			<div class="user-logo">
	  				...
	  				<h3>Dr <?php echo $fn ?> <?php echo $ln ?>  </h3>
</div>
</div>
<div id="clock"></div>
<h6 style="text-align: center;font-size: 31px;font-weight: 600;"><span id="current_month">May</span> <span id="current_day">5</span>, <span id="current_year">2014</span></h6>
  ...
  <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="patient_sicknote.php"><span class="fa fa-bar-chart mr-3"></span>Sicknotes</a>
          </li>
          
          <li>
            <a href="doctor_settings.php"><span class="fa fa-cog mr-3 mr-3"></span>Settings</a>
          </li>
          <li>
