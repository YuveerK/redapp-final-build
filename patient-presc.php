                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      <td>
                        <a href="doctor-patient-prescription.php?pid=<?php echo $row['pid']?>"
                        tooltip-placement="top" tooltip="Remove" title="Prescribe Patient">
                        <button class="btn btn-outline-success">Prescribe</button></a></td>
                      </tr></a>
                    <?php } ?>
                </tbody>
              </table>
