              ...
              <table class="table tabled-bordedtable-hover" id="myTable">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">View Patient History</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      <td>
                        <a href="doc-pathist.php?pid=<?php echo $row['pid']?>&fname=<?php echo $row['fname']?>&lname=<?php echo $row['lname']?>"
                        tooltip-placement="top" tooltip="Remove" title="View Patient History">
                        <button class="btn btn-outline-success">View</button></a></td>
                      </tr></a>
                    <?php } ?>
                </tbody>
              </table>
